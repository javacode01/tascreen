...
import com.yawei.client.gsyw.GsywClientConfig;
...
@MapperScan(basePackageClasses={GsywClientConfig.class},sqlSessionFactoryRef="sqlSessionFactoryGsyw")
@PropertySource("classpath:/datasource.properties")
public class MybatisGsywConfig {
	...
	public DataSource dataSourceGsyw() throws SQLException{
		DruidDataSource dataSource = new DruidDataSource();
		//基本属性 url、user、password
		dataSource.setUrl(env.getProperty("dataSource.url_gsyw"));
		dataSource.setUsername(env.getProperty("dataSource.username_gsyw"));
		dataSource.setPassword(env.getProperty("dataSource.password_gsyw"));
		//配置初始化大小、最小、最大
	 ...
	 */
	@Bean
	public DataSourceTransactionManager transactionManagerGsyw(DataSource dataSourceGsyw){
		DataSourceTransactionManager transactionManager = new DataSourceTransactionManager();
		transactionManager.setDataSource(dataSourceGsyw);
	 ...
	 */
	@Bean
	public SqlSessionFactoryBean sqlSessionFactoryGsyw(DataSource dataSourceGsyw) throws IOException{
		ResourcePatternResolver resourcePatternResolver = new PathMatchingResourcePatternResolver();  
        SqlSessionFactoryBean sqlSessionFactoryBean = new SqlSessionFactoryBean();  
        sqlSessionFactoryBean.setDataSource(dataSourceGsyw);  
        sqlSessionFactoryBean.setMapperLocations(resourcePatternResolver.getResources("classpath*:com/yawei/sqlmap/gsyw/**/*.xml"));  
